...
**Note:** Due to file size limitations, the dataset is not included in this repository. Please download `Loan_default.csv` from the Kaggle link above and place it in the project root directory before running the notebook.
...
1. Download `Loan_default.csv` from [Kaggle](https://www.kaggle.com/datasets/nikhil1e9/loan-default)
